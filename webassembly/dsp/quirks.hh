...
static constexpr int my_abs(int a) { return a < 0 ? -a : a; }
static inline float my_abs(float a) { return __builtin_fabsf(a); }
static inline double my_abs(double a) { return __builtin_fabs(a); }
namespace DSP { using ::my_abs; }
